...
.method private merge(Lorg/h2/result/Row;)V
    ...
    iget-object v4, p0, Lorg/h2/command/dml/Merge;->session:Lorg/h2/engine/Session;
    ...
    iget-object v3, p0, Lorg/h2/command/dml/Merge;->session:Lorg/h2/engine/Session;

    invoke-virtual {v0, v3, p1}, Lorg/h2/table/Table;->addRow(Lorg/h2/engine/Session;Lorg/h2/result/Row;)V

    .line 162
    iget-object v0, p0, Lorg/h2/command/dml/Merge;->session:Lorg/h2/engine/Session;
...
.method public getPlanSQL()Ljava/lang/String;
    ...
    .line 206
    invoke-virtual {v0, v8}, Lorg/h2/util/StatementBuilder;->appendExceptFirst(Ljava/lang/String;)V
...
.method public prepare()V
    ...
    .line 255
    iget-object v6, p0, Lorg/h2/command/dml/Merge;->session:Lorg/h2/engine/Session;
    ...
    .line 285
    iget-object v1, p0, Lorg/h2/command/dml/Merge;->session:Lorg/h2/engine/Session;
...
.method public update()I
    ...
    .line 85
    invoke-virtual {p0, v0}, Lorg/h2/command/dml/Merge;->setCurrentRowNumber(I)V
    ...
    .line 89
    invoke-virtual {p0, v4}, Lorg/h2/command/dml/Merge;->setCurrentRowNumber(I)V
    ...
    .line 99
    :try_start_0
    iget-object v11, p0, Lorg/h2/command/dml/Merge;->session:Lorg/h2/engine/Session;
    ...
    .line 102
    invoke-static {v2}, Lorg/h2/command/dml/Merge;->getSQL([Lorg/h2/expression/Expression;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v0, v3, v1}, Lorg/h2/command/dml/Merge;->setRow(Lorg/h2/message/DbException;ILjava/lang/String;)Lorg/h2/message/DbException;
    ...
    .line 118
    invoke-virtual {p0, v3}, Lorg/h2/command/dml/Merge;->setCurrentRowNumber(I)V
    ...
    .line 126
    invoke-static {v2}, Lorg/h2/command/dml/Merge;->getSQL([Lorg/h2/value/Value;)Ljava/lang/String;
    ...
    iget-object v2, p0, Lorg/h2/command/dml/Merge;->session:Lorg/h2/engine/Session;
