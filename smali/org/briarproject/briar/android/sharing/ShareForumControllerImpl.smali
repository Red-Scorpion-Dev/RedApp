.class Lorg/briarproject/briar/android/sharing/ShareForumControllerImpl;
.super Lorg/briarproject/briar/android/contactselection/ContactSelectorControllerImpl;
.source "ShareForumControllerImpl.java"

# interfaces
.implements Lorg/briarproject/briar/android/sharing/ShareForumController;
...
.method static constructor <clinit>()V
    ...
    .line 35
    const-class v0, Lorg/briarproject/briar/android/sharing/ShareForumControllerImpl;
    ...
    sput-object v0, Lorg/briarproject/briar/android/sharing/ShareForumControllerImpl;->LOG:Ljava/util/logging/Logger;
...
.method constructor <init>(Ljava/util/concurrent/Executor;Lorg/briarproject/bramble/api/lifecycle/LifecycleManager;Lorg/briarproject/bramble/api/contact/ContactManager;Lorg/briarproject/briar/api/conversation/ConversationManager;Lorg/briarproject/briar/api/forum/ForumSharingManager;Lorg/briarproject/bramble/api/system/Clock;)V
    ...
    .line 48
    iput-object p4, p0, Lorg/briarproject/briar/android/sharing/ShareForumControllerImpl;->conversationManager:Lorg/briarproject/briar/api/conversation/ConversationManager;

    .line 49
    iput-object p5, p0, Lorg/briarproject/briar/android/sharing/ShareForumControllerImpl;->forumSharingManager:Lorg/briarproject/briar/api/forum/ForumSharingManager;

    .line 50
    iput-object p6, p0, Lorg/briarproject/briar/android/sharing/ShareForumControllerImpl;->clock:Lorg/briarproject/bramble/api/system/Clock;

    return-void
.end method

.method public static synthetic lambda$share$0(Lorg/briarproject/briar/android/sharing/ShareForumControllerImpl;Ljava/lang/String;Ljava/util/Collection;Lorg/briarproject/bramble/api/sync/GroupId;Lorg/briarproject/briar/android/controller/handler/ExceptionHandler;)V
    .locals 7
    ...
    .line 66
    :try_start_1
    iget-object v0, p0, Lorg/briarproject/briar/android/sharing/ShareForumControllerImpl;->clock:Lorg/briarproject/bramble/api/system/Clock;

    invoke-interface {v0}, Lorg/briarproject/bramble/api/system/Clock;->currentTimeMillis()J

    move-result-wide v0

    iget-object v3, p0, Lorg/briarproject/briar/android/sharing/ShareForumControllerImpl;->conversationManager:Lorg/briarproject/briar/api/conversation/ConversationManager;
    ...
    .line 69
    iget-object v0, p0, Lorg/briarproject/briar/android/sharing/ShareForumControllerImpl;->forumSharingManager:Lorg/briarproject/briar/api/forum/ForumSharingManager;

    move-object v1, p3

    move-object v3, p1

    invoke-interface/range {v0 .. v5}, Lorg/briarproject/briar/api/forum/ForumSharingManager;->sendInvitation(Lorg/briarproject/bramble/api/sync/GroupId;Lorg/briarproject/bramble/api/contact/ContactId;Ljava/lang/String;J)V
    :try_end_1
    ...
    .line 71
    :try_start_2
    sget-object v1, Lorg/briarproject/briar/android/sharing/ShareForumControllerImpl;->LOG:Ljava/util/logging/Logger;
    ...
    .line 75
    sget-object p2, Lorg/briarproject/briar/android/sharing/ShareForumControllerImpl;->LOG:Ljava/util/logging/Logger;
...
.method protected isDisabled(Lorg/briarproject/bramble/api/sync/GroupId;Lorg/briarproject/bramble/api/contact/Contact;)Z
    ...
    invoke-interface {v0, p1, p2}, Lorg/briarproject/briar/api/forum/ForumSharingManager;->canBeShared(Lorg/briarproject/bramble/api/sync/GroupId;Lorg/briarproject/bramble/api/contact/Contact;)Z
...
.method public share(Lorg/briarproject/bramble/api/sync/GroupId;Ljava/util/Collection;Ljava/lang/String;Lorg/briarproject/briar/android/controller/handler/ExceptionHandler;)V
    ...
    .line 61
    new-instance v6, Lorg/briarproject/briar/android/sharing/-$$Lambda$ShareForumControllerImpl$CUJDe0-ilrvvzQw5NjjNIYQtI_w;
    ...
    invoke-direct/range {v0 .. v5}, Lorg/briarproject/briar/android/sharing/-$$Lambda$ShareForumControllerImpl$CUJDe0-ilrvvzQw5NjjNIYQtI_w;-><init>(Lorg/briarproject/briar/android/sharing/ShareForumControllerImpl;Ljava/lang/String;Ljava/util/Collection;Lorg/briarproject/bramble/api/sync/GroupId;Lorg/briarproject/briar/android/controller/handler/ExceptionHandler;)V

    invoke-virtual {p0, v6}, Lorg/briarproject/briar/android/sharing/ShareForumControllerImpl;->runOnDbThread(Ljava/lang/Runnable;)V
